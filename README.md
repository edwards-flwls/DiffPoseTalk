...
# inference SA-hubert-WM 
python demo.py \
--exp_name SA-hubert-WM \
--iter 100000 \
-a demo/input/audio/further_divide_our.flac \
-c demo/input/coef/TH050.npy \
-s demo/input/style/normal.npy \
-o TH050-further-normal.mp4 \
-n 3 -ss 3 -sa 1.15 \
--coef_stats models/data/stats_train.npz
